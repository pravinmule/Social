...
export default function Signup() {
    ...
    return (
        ...
        <div className=" py-4 flex items-center justify-center signupage ">
              <div className="w-full max-w-md">
                <form className=" bg-slate-300 shadow-lg rounded px-12  pb-8 mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input className="shadow  border rounded w-full py-2 px-3 text-gray-700  focus:outline-none focus:shadow-outline" name="name" type="email" placeholder="Name" />
                    </div>
                    <div className="mb-4">
                        <label className=" text-gray-700 text-sm font-normal mb-2" htmlFor="username">
                            Email
                    ...
                    <div className="mb-4">
                        ...
                        <input className="shadow  border rounded w-full py-2 px-3 text-gray-700  focus:outline-none focus:shadow-outline" name="mobile" type="email" placeholder="Mobile" />
                    </div>
                    <div className="mb-6">
